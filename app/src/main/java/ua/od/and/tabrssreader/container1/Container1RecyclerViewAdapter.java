...
public class Container1RecyclerViewAdapter extends RecyclerView.Adapter<Container1RecyclerViewAdapter.ViewHolder> {

    private final ArrayList<Article> list;
    private final Container1View.OnListFragmentInteractionListener1 listener2;

    Container1RecyclerViewAdapter(ArrayList<Article> list, Container1View.OnListFragmentInteractionListener1 listener) {
        this.list = list;
        listener2 = listener;
    }
